...
class CollectionsTest < ApplicationSystemTestCase
  ...
  test "creating a Collection" do
    ...
    fill_in "Balance", with: @collection.balance
    fill_in "Cl date", with: @collection.cl_date
    fill_in "Fix amount", with: @collection.fix_amount
    fill_in "Location", with: @collection.location
    fill_in "Name", with: @collection.name
    fill_in "Tag", with: @collection.tag_id
